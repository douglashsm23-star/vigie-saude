...
import { addStoredPatient, calcRisk } from "@/store/patientStore";
...
export default function NewPatient() {
  ...
  // Detecta o tipo de consulta baseado no perfil do usuário logado
  const consultaType = user?.specialty === "odontologia" ? "odonto" : "medico";
...
*👨‍⚕️ Profissional:* ${user?.name || "Dr(a)"}`;
  ...
  const criarQuestionarios = (
    ...
    console.log("CPF:", pacienteCpf);
    console.log("Comorbidades:", comorbidades);

    const questionariosPendentes: any[] = [];

    comorbidades.forEach((comorb) => {
      let questionario = null;

      // 1. HIPERTENSÃO
      if (comorb.includes("Hipertensão") || comorb === "Hipertensão Arterial") {
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento de Hipertensão",
          comorbidade: "Hipertensão",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "h1",
              texto: "Você aferiu sua pressão recentemente?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "h2",
              texto: "Qual o valor da sua pressão arterial? (Sistólica)",
              opcoes: [
                "<120",
                "120-129",
                "130-139",
            ...
            {
              id: "h3",
              texto: "Qual o valor da sua pressão arterial? (Diastólica)",
              opcoes: ["<80", "80-84", "85-89", "90-99", "100-109", "≥110"],
            },
            {
              id: "h4",
              texto: "Sua pressão arterial está controlada?",
              opcoes: ["Sim", "Não", "Não sei"],
            },
            {
              id: "h5",
              texto: "Teve dor de cabeça nas últimas 24h?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "h6",
              texto: "Sentiu tontura ao levantar?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "h7",
              texto: "Tomou sua medicação hoje?",
              opcoes: ["Sim", "Não"],
            },
          ],
          respondido: false,
      ...
      // 2. DIABETES
        ...
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento de Diabetes",
          comorbidade: "Diabetes",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "d1",
              texto: "Você aferiu sua glicemia recentemente?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "d2",
              texto: "Qual o valor da sua glicemia em jejum? (mg/dL)",
              opcoes: ["<100", "100-125", "126-199", "≥200"],
            },
            {
              id: "d3",
              texto: "Sua glicemia está controlada?",
              opcoes: ["Sim", "Não", "Não sei"],
            },
            {
              id: "d4",
              texto: "Teve formigamento nos pés ou mãos?",
              opcoes: ["Sim", "Não"],
            },
            { id: "d5", texto: "Sentiu visão turva?", opcoes: ["Sim", "Não"] },
            {
              id: "d6",
              texto: "Tomou sua medicação para diabetes hoje?",
              opcoes: ["Sim", "Não"],
            },
          ],
          respondido: false,
      ...
      // 3. ODONTOLÓGICO
      else if (comorb === "Odontológico") {
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento Odontológico",
          comorbidade: "Odontológico",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "od1",
              texto: "A dor está controlada com a medicação?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "od2",
              texto: "Teve sangramento que não parou?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "od3",
              texto: "Teve febre ou inchaço no rosto?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "od4",
              texto: "Sentiu gosto ruim ou secreção no local?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "od5",
              texto: "A prótese está causando desconforto?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "od6",
              texto: "Consegue mastigar normalmente?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "od7",
              texto: "A dor na mandíbula piorou?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "od8",
              texto: "Suas gengivas estão sangrando?",
              opcoes: ["Sim", "Não"],
            },
          ],
          respondido: false,
      ...
      // 4. ASMA / RESPIRATÓRIO
      else if (comorb.includes("Asma") || comorb.includes("Respiratória")) {
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento Respiratório",
          comorbidade: "Respiratória",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "r1",
              texto: "Teve falta de ar nas últimas 24h?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "r2",
              texto: "Usou a medicação de resgate (bombinha)?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "r3",
              texto: "Acordou com chiado no peito?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "r4",
              texto: "Teve tosse seca persistente?",
              opcoes: ["Sim", "Não"],
            },
          ],
          respondido: false,
      ...
      // 5. SAÚDE MENTAL
      else if (comorb.includes("Saúde Mental")) {
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento de Saúde Mental",
          comorbidade: "Saúde Mental",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "m1",
              texto: "Como está seu humor nos últimos dias?",
              opcoes: ["Bom", "Regular", "Ruim"],
            },
            {
              id: "m2",
              texto: "Teve dificuldade para dormir?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "m3",
              texto: "Sentiu ansiedade excessiva?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "m4",
              texto: "Sentiu-se para baixo ou sem esperança?",
              opcoes: ["Sim", "Não"],
            },
          ],
          respondido: false,
      ...
      // 6. OBESIDADE
      else if (comorb.includes("Obesidade")) {
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento de Obesidade",
          comorbidade: "Obesidade",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "o1",
              texto: "Seu peso mudou significativamente?",
              opcoes: ["Aumentou", "Mesmo", "Diminuiu"],
            },
            {
              id: "o2",
              texto: "Praticou atividade física esta semana?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "o3",
              texto: "Manteve alimentação saudável?",
      ...
      // 7. RENAL CRÔNICO
      else if (comorb.includes("Renal")) {
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento Renal",
          comorbidade: "Renal",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "k1",
              texto: "Notou inchaço nos pés ou tornozelos?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "k2",
              texto: "Teve diminuição na quantidade de urina?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "k3",
              texto: "Sentiu cansaço excessivo?",
              opcoes: ["Sim", "Não"],
            },
          ],
          respondido: false,
      ...
      // 8. CÂNCER
      else if (comorb.includes("Câncer") || comorb.includes("Neoplasia")) {
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento Oncológico",
          comorbidade: "Câncer",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "c1",
              texto: "Teve dor nova ou intensificada?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "c2",
              texto: "Perdeu peso sem motivo?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "c3",
              texto: "Teve febre ou calafrios?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "c4",
              texto: "Teve cansaço extremo?",
              opcoes: ["Sim", "Não"],
            },
          ],
          respondido: false,
      ...
      // 9. HIV
        ...
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento HIV",
          comorbidade: "HIV",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "i1",
              texto: "Tomou sua medicação antirretroviral corretamente?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "i2",
              texto: "Teve febre ou suor noturno?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "i3",
            ...
            {
              id: "i4",
              texto: "Apareceu lesão na pele ou boca?",
              opcoes: ["Sim", "Não"],
            },
          ],
          respondido: false,
      ...
      // 10. HEPATITE
      else if (comorb.includes("Hepatite")) {
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento Hepático",
          comorbidade: "Hepatite",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "he1",
              texto: "Tomou a medicação corretamente?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "he2",
              texto: "Notou amarelamento da pele ou olhos?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "he3",
              texto: "Teve sangramento (gengivas, fezes escuras)?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "he4",
              texto: "Sentiu confusão mental?",
              opcoes: ["Sim", "Não"],
            },
          ],
          respondido: false,
      ...
      // 11. DOENÇAS INFLAMATÓRIAS INTESTINAIS
        ...
        comorb.includes("Intestinal") ||
        comorb.includes("Crohn") ||
        comorb.includes("Retocolite")
      ) {
        questionario = {
          id: Date.now() + Math.random(),
          tipo: "Monitoramento de Doenças Inflamatórias Intestinais",
          comorbidade: "Doenças Inflamatórias Intestinais",
          dataEnvio: new Date().toISOString(),
          perguntas: [
            {
              id: "dii1",
              texto: "Teve diarreia com sangue?",
              opcoes: ["Sim", "Não"],
            },
            {
              id: "dii2",
              texto: "Teve dor abdominal intensa?",
              opcoes: ["Sim", "Não"],
            },
            { id: "dii3", texto: "Perdeu peso?", opcoes: ["Sim", "Não"] },
            { id: "dii4", texto: "Teve febre?", opcoes: ["Sim", "Não"] },
          ],
          respondido: false,
        };
      }
      ...
      if (questionario) {
        questionariosPendentes.push(questionario);
      }
    });
    ...
    if (questionariosPendentes.length > 0) {
      ...
      console.log(
        `✅ ${questionariosPendentes.length} questionário(s) criado(s) para ${pacienteNome}`,
      );
    }
  };
