...
import { getStoredPatients, RISK_COLOR } from "@/store/patientStore";
      ...
      <div className="max-w-lg mx-auto px-4 pt-6 space-y-5">
        ...
        <div className="bg-white rounded-[32px] border border-slate-200 p-6 shadow-sm relative overflow-hidden">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1.5">
                <StatusBadge
                  status={
                    patient.status ||
                    (patient.finalRisk === "high" ? "critical" : "stable")
                  }
                />
          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            ...
            <PainIndicator level={patient.painLevel || 0} showLabel={false} />
          </div>
        </div>
